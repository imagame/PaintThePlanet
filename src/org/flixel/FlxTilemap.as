package org.flixel
{
	...
	public class FlxTilemap extends FlxObject
	{
		...
		public function overlapsWithCallback(Object:FlxObject,Callback:Function=null,FlipCallbackParams:Boolean=false,Position:FlxPoint=null):Boolean
		{
			...
			/*
			var selectionWidth:uint = selectionX + (FlxU.ceil(Object.width / _tileWidth));
			if (selectionWidth == selectionX)
				selectionWidth++;
			var selectionHeight:uint = selectionY + FlxU.ceil(Object.height / _tileHeight);
			if (selectionHeight == selectionY)
				selectionHeight++;
				*/
			...
			while(row < selectionHeight)
			{
				...
				while(column < selectionWidth)
				{
					...
					//RPG: cambio, miro primero si overlapfound, antes de llamar a callback
					//TODO: tener en cuenta para el overlap bounding-box reducido
					{
